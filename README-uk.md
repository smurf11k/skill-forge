...
### Доступ для адміністратора та тестового співробітника

Щоб увійти як Адміністратор або Тестовий співробітник, використовуйте наступні облікові дані:

- Обліковий запис Адміністратора
  - email: `admin@skillforge.com`
  - пароль: `admin123`
- EОбліковий запис Співробітника
  - email: `employee@skillforge.com`
  - пароль: `employee123`

Для всіх інших облікових записів, створених через seeder, використовуйте пароль `mock123` для входу.

Ці облікові записи можна використовувати для тестування функціоналу платформи з різними ролями користувачів. Якщо ви хочете додати більше тестових користувачів, це можна зробити через керування обліковими записами у панелі адміністратора.
